 ...
 */
final class Version20210527110144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee ADD gender INT NOT NULL, CHANGE salary salary int NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee DROP gender, CHANGE salary salary INT NOT NULL');
